...
class TestRiskDistribution(unittest.TestCase):
    ...
    def test_assign_patient_risks_basic(self):
        ...
        self.assertAlmostEqual(
            np.mean(risks), self.annual_incident_rate, places=3)
    ...
    def test_assign_patient_risks_concentration(self):
        ...
        risks_low = assign_patient_risks(
            10000, 0.1, concentration=0.1, random_seed=42)
        risks_high = assign_patient_risks(
            10000, 0.1, concentration=2.0, random_seed=42)
    ...
    def test_simulate_annual_incidents_basic(self):
        ...
        counts = simulate_annual_incidents(
            risks, n_simulations=100, random_seed=42)
    ...
    def test_simulate_annual_incidents_variance(self):
        ...
        counts = simulate_annual_incidents(
            risks, n_simulations=1000, random_seed=42)
        ...
        self.assertAlmostEqual(
            observed_var, expected_var, delta=expected_var * 0.1)

    def test_risk_distribution_properties(self):
        """Test statistical properties of risk distribution."""
        risks = assign_patient_risks(
            10000, 0.1, concentration=0.5, random_seed=42)
